...
const SCENES = [
  ['🌅 Dawn · killed', 'A kill lands. Grim tone, role card tossed at the corner, somber tail on the sound.',
  ...
  ['⚖️ Verdict · Prowler caught', 'Good tone, applause and confetti.',
    () => renderSleepless(sl({ phase: 'verdict', players: dead(['p4']), verdict: { outId: 'p4', role: 'prowler', tie: false, tally: { p4: 3 }, skips: 0, round: 2 }, votes: { p1: 'p4', p2: 'p4', p3: 'p4' } }), ctx)],
  ['⚖️ Verdict · innocent out', 'Grim tone, sad trombone. The Prowler is still at the table.',
  ...
  ['⚖️ Verdict · tie', 'Nobody goes home.',
